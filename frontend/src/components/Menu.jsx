...
const Menu = ({ closeMenu, showMenu }) => {
    ...
    return (
        <section ref={menuRef} className={`${showMenu ? 'opacity-100 transition-opacity ease-in-out duration-500' : 'opacity-0 transition-opacity ease-in-out duration-500'} absolute top-[3.57rem] left-0 w-full h-fit menu-bar-style shadow shadow-red-300`}>
